...
public class M_Pickup : MonoBehaviour
{
    ...
    public static M_Pickup Instance;
    ...
    private void Awake()
    {
        ...
        {
            Instance = this;
            ServiceLocator.RegisterPickupManager(this);
    ...
    // Responsbiel for pickup types according to their probability based on player rank
