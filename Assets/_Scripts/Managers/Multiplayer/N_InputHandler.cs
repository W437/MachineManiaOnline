...
public class N_InputHandler : MonoBehaviour, INetworkRunnerCallbacks
{
    private NetworkRunner runner;

    private void Start()
    {
        runner = ServiceLocator.GetNetworkManager().GetNetworkRunner();
        if (runner != null)
        {
    ...
    {
        N_InputData data = new N_InputData
        {
