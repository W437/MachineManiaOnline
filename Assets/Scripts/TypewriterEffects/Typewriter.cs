...
namespace Assets.Scripts.TypewriterEffects
{
    public class Typewriter : MonoBehaviour
    {
        ...
        public static void CleanText(ref string input)
        {
            string pattern = @"<\s*(?!sprite)(?!\/?i)[^>]+>"; // Keeps <sprite> and <i> tags
            input = System.Text.RegularExpressions.Regex.Replace(input, pattern, string.Empty);
        }
