...
namespace Fusion.Addons.Physics
{
    ...
    public class NetworkRigidbody2D : NetworkRigidbody<Rigidbody2D, RunnerSimulatePhysics2D>
    {
        ...
        {
            get => new Vector3(_rigidbody.position.x, _rigidbody.position.y, _positionZ);
            set
            {
                _rigidbody.position = new Vector2(value.x, value.y);
                _positionZ = value.z;
            }
        }
        ...
        {
            data.TRSPData.Position = new Vector3(rb.position.x, rb.position.y, _positionZ);
        ...
        protected override void ApplyExtras(Rigidbody2D rb, ref NetworkRBData data)
        {
            ...
            rb.angularVelocity = data.AngularVelocity2D;
